...
class SmsSender{
	...
	$this->logger = new KLogger ( "RequestResponse.log" , KLogger::DEBUG );
    }
    ...
    **/
	...
	$this->logger->LogDebug("sendRequest() : Request=".$jsonObjectFields);
	...
	$this->logger->LogDebug("sendRequest() : Response=".$res);
