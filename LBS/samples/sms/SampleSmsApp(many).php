...
try {
    ...
    $charging_amount = "";
    $destinationAddresses = ["tel:".$_POST["msisdn1"],"tel:".$_POST["msisdn2"],"tel:".$_POST["msisdn3"],"tel:".$_POST["msisdn4"],"tel:".$_POST["msisdn5"]];
	//["tel:B%3C4EsLy02JT8YRBys4q8izpb4tvim/ocSff3QhjcLZQjA6IHi/wf1ugRSOoTVeOqjtt", "tel:AZ110hnY8eJS5Cpmh+Qz9eosg+n4y27OX4H5AxZgXWLYuNvmZEvuYFhAylgZ50cePg31Z"];
